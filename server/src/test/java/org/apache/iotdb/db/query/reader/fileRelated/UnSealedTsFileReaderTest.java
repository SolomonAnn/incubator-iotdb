...
public class UnSealedTsFileReaderTest extends ReaderTestHelper {
  ...
  @Test
  public void testUnSealedTsFileIterateReader() throws IOException, PathErrorException {
  ...
  @Test
  public void testUnSealedTsFileReaderByTimestamp() throws IOException, PathErrorException {
    QueryDataSource queryDataSource = storageGroupProcessor.query(devicePath, measurementPath, context,
        null);
    TsFileResource resource = queryDataSource.getSeqResources().get(0);
    Assert.assertFalse(resource.isClosed());
