...
public class PhysicalPlanTest {
  ...
  public void before() throws ProcessorException {
    ...
    processor.getExecutor()
        .insert(new InsertPlan(path1.getDevicePath(), 10, path1.getMeasurementPath(), "10"));
    processor.getExecutor()
        .insert(new InsertPlan(path2.getDevicePath(), 10, path2.getMeasurementPath(), "10"));
    processor.getExecutor()
        .insert(new InsertPlan(path3.getDevicePath(), 10, path3.getMeasurementPath(), "10"));
    processor.getExecutor()
        .insert(new InsertPlan(path4.getDevicePath(), 10, path4.getMeasurementPath(), "10"));
  }
