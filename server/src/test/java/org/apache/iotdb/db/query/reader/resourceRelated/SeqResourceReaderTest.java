...
public class SeqResourceReaderTest extends ReaderTestHelper {
  ...
  @Test
  public void testSeqResourceIterateReader() throws IOException, PathErrorException {
  ...
  @Test
  public void testSeqResourceReaderByTimestamp() throws IOException, PathErrorException {
    QueryDataSource queryDataSource = storageGroupProcessor.query(devicePath, measurementPath, context,
        null);
    Path path = new Path(devicePath, measurementPath);
