  ...
  public void testSlimitLogicalOptimize()
    ...
    Path path4 = new Path(
        new StringContainer(new String[]{"root", "vehicle", "d4", "s1"},
            TsFileConstant.PATH_SEPARATOR));
    executor.insert(new InsertPlan(path1.getDevicePath(), 10, path1.getMeasurementPath(), "10"));
    executor.insert(new InsertPlan(path2.getDevicePath(), 10, path2.getMeasurementPath(), "10"));
    executor.insert(new InsertPlan(path3.getDevicePath(), 10, path3.getMeasurementPath(), "10"));
    executor.insert(new InsertPlan(path4.getDevicePath(), 10, path4.getMeasurementPath(), "10"));
