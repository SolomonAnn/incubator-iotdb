...
//            TsFileConstant.PATH_SEPARATOR));
//    executor.insert(new InsertPlan(path1.getDevicePath(), 10, path1.getMeasurement(), "10"));
//    executor.insert(new InsertPlan(path2.getDevicePath(), 10, path2.getMeasurement(), "10"));
//    executor.insert(new InsertPlan(path3.getDevicePath(), 10, path3.getMeasurement(), "10"));
//    executor.insert(new InsertPlan(path4.getDevicePath(), 10, path4.getMeasurement(), "10"));
